...
const restaurants: Restaurant[] = [
  {
    ...
    score: 4.5,
    ratings: 100,
    image: "https://media.admagazine.com/photos/651aeed9da5f4d9a3844a94b/4:3/w_2660,h_1995,c_limit/Porten%CC%83o-restaurante-1.jpg",
  },
  {
    id: "2",
    name: "La Piazza",
    ...
    score: 4.2,
    ratings: 80,
    image: "https://www.lavanguardia.com/files/og_thumbnail/files/fp/uploads/2021/12/23/61c456cc62a0b.r_d.2520-1680-0.jpeg",
  },
  {
    id: "3",
    ...
    score: 4.8,
    ratings: 120,
    image: "https://blog.winesofargentina.com/wp-content/uploads/2022/11/PORTADA-restos-baires-1024x427.jpg",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    score: 4.3,
    ratings: 70,
    image: "https://alimentika.cl/wp-content/uploads/2023/09/Consejos-de-administracion-para-restaurantes-pequenos.webp",
  },
  {
    id: "7",
    ...
    score: 4.9,
    ratings: 150,
    image: "https://hips.hearstapps.com/hmg-prod/images/elle-restaurantes-decoracion-bonita-instagram-raimunda-madrid-1573068471.jpg?crop=0.9333333333333333xw:1xh;center,top&resize=1200:*",
  },
  {
    id: "8",
...
const api = {
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vQqM_rtim0lap68swKxGVZCUqCZsHzN0aEwH61XUZKsTclLeLtmYMHuVdPQpYSDyLsuRuxEIFIIKBAX/pub?output=csv')
    .then(res => res.text())
